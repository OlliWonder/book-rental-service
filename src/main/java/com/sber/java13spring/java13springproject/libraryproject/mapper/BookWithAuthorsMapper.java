...
public class BookWithAuthorsMapper extends GenericMapper<Book, BookWithAuthorsDTO> {
    ...
    protected BookWithAuthorsMapper(ModelMapper modelMapper, AuthorRepository authorRepository) {
    ...
    protected Set<Long> getIds(Book entity) {
        return Objects.isNull(entity) || Objects.isNull(entity.getId()) ? null : entity.getAuthors()
                .stream()
